...
#! Comments
comment1 = Comment.create({"artwork_id"=> art4.id, "user_id" => user3.id, "body" => "This art sucks"})
comment2 = Comment.create({"artwork_id"=> art2.id, "user_id" => user2.id, "body" => "I'm amazing"})
comment3 = Comment.create({"artwork_id"=> art1.id, "user_id" => user1.id, "body" => "My art sucks"})
